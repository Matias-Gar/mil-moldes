...
export const ADMIN_MENU = [
  {
    ...
    children: [
      { label: 'Mi Perfil', path: '/admin/perfil', roles: ['admin', 'administracion', 'vendedor', 'almacen'] },
  ...
  },
  {
    ...
    children: [
      ...
      { label: 'Auditoría de Stock', path: '/admin/ventas/auditoria', roles: ['admin', 'administracion'] },
  ...
  },
  {
    ...
    children: [
      ...
      { label: 'Todas las ventas', path: '/admin/ventas/todas', roles: ['admin', 'administracion'] },
      { label: 'Estadística', path: '/admin/ventas/estadistica', roles: ['admin', 'administracion'] },
    ],
  },
  {
    label: 'Pagos',
